...
const ParseSongsByJsonUrl = (url, options, callback) => {

    const jar = options && options.jar ? options.jar : null;
...
const ParseSongByDetailUrl = (url, callback) => {
...
const ParseSongByIds = (songIds, isAlive, callback) => {
